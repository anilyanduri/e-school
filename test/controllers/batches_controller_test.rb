...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference("Batch.count") do
      post batches_url, params: { batch: { course_id: @batch.course_id, name: @batch.name, status: @batch.status } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { course_id: @batch.course_id, name: @batch.name, status: @batch.status } }
